...
{
       0,    68,    68,    72,    73,    86,    88,    90,    91,    93,
     109,   110,   111,   113,   128,   143,   152,   155,   159,   160,
     162,   165,   166,   168,   169,   184,   185,   186,   187,   188,
     189,   190,   192,   193,   196,   211,   230,   245,   261,   262,
     264,   266,   272,   278,   287,   293,   295,   296,   303,   304,
     311,   312,   319,   326,   327,   334,   341,   348,   355,   356,
     365,   372,   373,   380,   387,   392,   393,   397,   401,   418,
     426,   427,   428,   429,   430
};
#endif
...
#line 143 "parser.y"
                                                    { (yyval.tree) = (yyvsp[-2].tree); 
                                                      ...
                                                      if(strcmp((yyvsp[-2].tree)->label, "main") == 0 && (yyvsp[-1].tree)->code->size != 0){
                                                        (yyvsp[-1].tree)->code->instructions[0].label = strdup("L1");
                                                        add_instruction_to_program((yyvsp[-1].tree)->code, create_instruction(halt, NULL, NULL, NULL, NULL, 0));
                                                        set_main();
                                                      }
...
#line 211 "parser.y"
                                  { (yyval.tree) = asd_new("="); 
                                    ...
                                    add_instruction_to_program((yyval.tree)->code, create_instruction(loadI, temp_offset, temp_offset_register, NULL, NULL, 2));
                                    add_instruction_to_program((yyval.tree)->code, create_instruction(storeAI, (yyvsp[0].tree)->temp, temp_offset_register, (yyval.tree)->is_global ? "rbss" : "rfp", NULL, 3));
